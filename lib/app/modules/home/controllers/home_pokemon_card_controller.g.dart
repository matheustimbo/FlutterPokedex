...
part of 'home_pokemon_card_controller.dart';
...
mixin _$HomePokemonCardController on _HomePokemonCardControllerBase, Store {
  final _$loadingPokemonDetailsAtom =
      Atom(name: '_HomePokemonCardControllerBase.loadingPokemonDetails');
  ...
  final _$pokemonDetailsAtom =
      Atom(name: '_HomePokemonCardControllerBase.pokemonDetails');
